...
std::vector<mime_type_t> mimetypes;

std::string get_mime_type (std::string extention) {
    static std::vector<mime_type_t> cache;
    
    if (extention.length() <= 0) return "";

    init_mimetypes();

    int cache_size = cache.size();
    int mime_size = mimetypes.size();

    for (int i = 0; i < cache_size; i++) {
        if (cache[i].extension.compare(extention) == 0) {
            return cache[i].mimetype;
        }
    }

    for (int i = 0; i < mime_size; i++) {
        if (mimetypes[i].extension.compare(extention) == 0) {
            cache.push_back(mimetypes[i]);
...
void init_mimetypes() {
    ...
    mime_type_t mimetypes_clone[] = {
        ...
        {"application/vnd.afpc.modca", "listafp"},
        {"application/vnd.afpc.modca", "afp"},
        ...
        {"application/vnd.commerce-battelle", "icd"},
        {"application/vnd.commerce-battelle", "ic0"},
        {"application/vnd.commerce-battelle", "ic1"},
        {"application/vnd.commerce-battelle", "ic2"},
        ...
        {"application/vnd.geocube+xml", "g3"},
        ...
        {"application/vnd.lotus-notes", "nsh"},
        ...
        {"application/vnd.oma.drm.dcf", "o4a"},
        ...
        {"application/x-troff-man", "2"},
        {"application/x-troff-man", "3"},
        {"application/x-troff-man", "4"},
        {"application/x-troff-man", "5"},
        {"application/x-troff-man", "6"},
        {"application/x-troff-man", "7"},
        {"application/x-troff-man", "8"},
    ...
    int mime_size = sizeof(mimetypes_clone) / sizeof(mimetypes_clone[0]);

    for (int i = 0; i < mime_size; i++)
    {
        mimetypes.push_back(mimetypes_clone[i]);
    }
